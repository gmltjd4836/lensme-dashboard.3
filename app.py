...
with tab_map:
    ...
    # 💡 꿀팁: key 값을 좌표로 주면 지도가 안 바뀌는 버그를 강제로 해결합니다!
    st_folium(m, width="100%", height=600, key=f"map_{st.session_state.center_lat}_{st.session_state.center_lon}")

# (탭 2: 유동인구, 탭 3: 레이더차트, 탭 4: ROI는 그대로 유지)
with tab_pop:
